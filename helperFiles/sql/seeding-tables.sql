...
VALUES
  (1, 'ESCo-A001', 'Jason', 'Makgato', 'Mr', 'jason@escosa.co.za', '0821231111', 'hashedpassword1', 1, 'Super Admin', '2025-08-01 10:11:00'),
  (2, 'ESCo-A002', 'Thabo', 'Ndlovu', 'Mrs', 'thabo@greenco.co.za', '0832222222', 'hashedpassword2', 1, 'User', '2025-07-29 08:00:00');
...
INSERT INTO sector_experience
  (se_id, se_industry, se_isOther, se_isDeleted, se_esco_id)
VALUES
  (1, 'Solar PV', 0, 0, 'ESCo-A001'),
  (2, 'Biogas', 0, 0, 'ESCo-A001'),
  (3, 'LED Lighting', 0, 0, 'ESCo-A002'),
  (4, 'HVAC', 0, 0, 'ESCo-A002'),
  (5, 'Other', 1, 0, 'ESCo-A002');
...
INSERT INTO company_information (
    ...
    (1, 'ESCo-A001', '5+', '7+', 'Gauteng, Free State'),
    (2, 'ESCo-A002', '2-4', '1-3', 'Western Cape, Limpopo');
...
VALUES
  (1, 'MegaPower Ltd',    'Sibongile Ndlovu', '0831234567', 'Solar PV installation for office park',        'Solar PV,Energy Storage',   120000, '2023-03-01 00:00:00', '2023-09-30 00:00:00', 0, 'ESCo-A001'),
  (2, 'GreenCo Group',    'John Nkosi',       '0821112222', 'Biogas plant implementation and maintenance', 'Biogas',                    80000,  '2022-06-15 00:00:00', '2023-02-15 00:00:00', 0, 'ESCo-A001'),
  (3, 'Waterwise Pty',    'Maria Smith',      '0823334444', 'Water heating system retrofit',               'Heat Pumps',                50000,  '2024-01-10 00:00:00', '2024-06-05 00:00:00', 0, 'ESCo-A002'),
  (4, 'Bright Future SA', 'Thabo Moeketsi',   '0715550000', 'LED Lighting upgrade for warehouse',          'LED Lighting',              65000,  '2023-09-01 00:00:00', '2023-12-01 00:00:00', 0, 'ESCo-A003'),
  (5, 'FreshFarms Ltd',   'Lucy Chauke',      '0829876543', 'Cold room insulation project',                'Insulation,HVAC',           70000,  '2022-10-01 00:00:00', '2023-03-01 00:00:00', 0, 'ESCo-A004');
